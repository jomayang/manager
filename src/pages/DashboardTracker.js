  ...
  useEffect(() => {
    const fetchWeeklyDeliveryRate = async () => {
      try {
        ...
        console.log('some some', dataO, dataD, formattedEndingDate, formattedStartingDate);
        if (dataD && dataO) {
          ...
          console.log('weekly delivery rate: ', deliveryRateTemp);
    ...
    const fetchOrderSituations = async () => {
      try {
        ...
        if (data) {
          ...
          console.log('data tracker in: ', data);
          ...
          console.log('order dict: ', orderStatusDict);
